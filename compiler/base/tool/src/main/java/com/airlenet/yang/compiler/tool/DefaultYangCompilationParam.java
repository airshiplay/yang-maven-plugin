...
public final class DefaultYangCompilationParam implements YangCompilationParam {
    ...
    private DefaultYangCompilationParam(Set<Path> files, Set<Path>
            schemas, Path metaPath, String id, Path path,String genPackage,String f,String yangFilesDir) {
        yangFiles = unmodifiableSet(files);
        dependentSchemas = unmodifiableSet(schemas);
        modelId = id;
        codeGenDir = path;
        metaDataPath = metaPath;
        codeGenPackage = genPackage;
        format = f;
        this.yangFilesDir =yangFilesDir;
    }
    @Override
    ...
    public String toString() {
        return toStringHelper(getClass())
                ...
                .add("modelId", modelId)
                .add("format", format)
                .add("codeGenPackage", codeGenPackage)
                .toString();
    }
    ...
    public static class Builder {
        ...
        public Builder setCodeGenPackage(String genPackage) {
            codeGenPackage = genPackage;
            return this;
        }

        public Builder setFormat(String f) {
            format = f;
            return this;
        }

        public Builder setYangFilesDir(String yangFilesDir) {
            this.yangFilesDir = yangFilesDir;
            return this;
        }
        ...
        public DefaultYangCompilationParam build() {
            return new DefaultYangCompilationParam(
                    ...
                    codeGenDir,codeGenPackage,format,yangFilesDir);
        }
    }
}
