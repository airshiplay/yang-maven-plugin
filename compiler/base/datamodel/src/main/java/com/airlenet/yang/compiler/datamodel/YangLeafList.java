...
import com.airlenet.yang.compiler.datamodel.utils.builtindatatype.LeafContextUtil;
import com.airlenet.yang.model.DataNode;
import com.airlenet.yang.model.LeafObjectType;
import com.airlenet.yang.model.LeafRestriction;
...
public abstract class YangLeafList extends DefaultLocationInfo
    ...
    public boolean isEmptyDataType() {
        return DataModelUtils.validateEmptyDataType(dataType);
    }
    ...
    public LeafObjectType getLeafObjectType() {
        return DataModelUtils.getLeafTypeByDataType(dataType, dataType.getDataType());
    }
