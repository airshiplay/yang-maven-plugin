...
public class YangMaxElement extends DefaultLocationInfo
    ...
    public YangMaxElement() {
        ...
        yangAppErrorInfo.setErrorTag(YangErrMsgConstants.OPERATION_FAILED_ERROR_TAG);
        yangAppErrorInfo.setErrorAppTag(YangErrMsgConstants.TOO_MANY_ELEMENTS_ERROR_APP_TAG);
    }
