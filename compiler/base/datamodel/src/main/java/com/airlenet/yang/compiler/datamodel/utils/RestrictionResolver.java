...
import com.airlenet.yang.compiler.datamodel.YangRangeInterval;
import com.airlenet.yang.compiler.datamodel.YangRangeRestriction;

import static java.util.regex.Pattern.quote;
import static com.airlenet.yang.compiler.datamodel.BuiltInTypeObjectFactory.getDataObjectFromString;
...
public final class RestrictionResolver {
    ...
    public static YangRangeRestriction processLengthRes(YangRangeRestriction refLr,
        ...
        return getRestriction(refLr, line, position, hasRefR, curLr, fileName,
                              YangDataTypes.UINT64, LENGTH_DATA);
    }
