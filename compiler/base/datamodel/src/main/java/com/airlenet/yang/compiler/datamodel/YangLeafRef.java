...
import com.airlenet.yang.compiler.datamodel.utils.YangErrMsgConstants;
...
public class YangLeafRef<T> extends DefaultLocationInfo
    ...
    public YangLeafRef() {
        ...
        yangAppErrorInfo.setErrorTag(YangErrMsgConstants.DATA_MISSING_ERROR_TAG);
        yangAppErrorInfo.setErrorAppTag(YangErrMsgConstants.INSTANCE_REQUIRED_ERROR_APP_TAG);
        yangAppErrorInfo.setErrorAppPath(YangErrMsgConstants.ERROR_PATH_LEAFREF_LEAF);
    }
        ...
        if (getReferredLeafOrLeafList() instanceof YangLeaf) {
            ...
            if (baseType.getDataType() == YangDataTypes.LEAFREF) {
                ...
                if (referredLeafRefInfo.getResolvableStatus() != ResolvableStatus.INTRA_FILE_RESOLVED
                        && referredLeafRefInfo.getResolvableStatus() != ResolvableStatus.RESOLVED) {
