...
import com.airlenet.yang.compiler.datamodel.InvalidOpTypeHolder;
...
import com.airlenet.yang.compiler.translator.tojava.JavaAttributeInfo;
...
import com.airlenet.yang.compiler.utils.io.impl.JavaDocGen.JavaDocType;
...
import static com.airlenet.yang.compiler.translator.tojava.GeneratedJavaFileType.GENERATE_EVENT_SUBJECT_CLASS;
...
import static com.airlenet.yang.compiler.translator.tojava.utils.BracketType.OPEN_CLOSE_BRACKET;
import static com.airlenet.yang.compiler.translator.tojava.utils.IndentationType.EIGHT_SPACE;
import static com.airlenet.yang.compiler.translator.tojava.utils.IndentationType.FOUR_SPACE;
import static com.airlenet.yang.compiler.translator.tojava.utils.IndentationType.TWELVE_SPACE;
import static com.airlenet.yang.compiler.translator.tojava.utils.JavaFileGeneratorUtils.getAugmentedClassNameForDataMethods;
import static com.airlenet.yang.compiler.translator.tojava.utils.JavaFileGeneratorUtils.getCurNodeName;
import static com.airlenet.yang.compiler.translator.tojava.utils.JavaFileGeneratorUtils.getIdName;
import static com.airlenet.yang.compiler.translator.tojava.utils.JavaFileGeneratorUtils.getReturnType;
import static com.airlenet.yang.compiler.translator.tojava.utils.JavaFileGeneratorUtils.getSetOfNodeIdentifiers;
import static com.airlenet.yang.compiler.translator.tojava.utils.JavaFileGeneratorUtils.getYangDataStructure;
import static com.airlenet.yang.compiler.translator.tojava.utils.JavaIdentifierSyntax.getEnumJavaAttribute;
import static com.airlenet.yang.compiler.translator.tojava.utils.MethodBodyTypes.GETTER;
import static com.airlenet.yang.compiler.translator.tojava.utils.MethodBodyTypes.MANAGER_METHODS;
import static com.airlenet.yang.compiler.translator.tojava.utils.MethodBodyTypes.SETTER;
import static com.airlenet.yang.compiler.translator.tojava.utils.MethodBodyTypes.TO_STRING;
import static com.airlenet.yang.compiler.translator.tojava.utils.MethodClassTypes.CLASS_TYPE;
import static com.airlenet.yang.compiler.translator.tojava.utils.MethodClassTypes.INTERFACE_TYPE;
import static com.airlenet.yang.compiler.translator.tojava.utils.StringGenerator.brackets;
import static com.airlenet.yang.compiler.translator.tojava.utils.StringGenerator.getBitSetAttr;
import static com.airlenet.yang.compiler.translator.tojava.utils.StringGenerator.getCatchSubString;
import static com.airlenet.yang.compiler.translator.tojava.utils.StringGenerator.getCompareToString;
import static com.airlenet.yang.compiler.translator.tojava.utils.StringGenerator.getElseIfConditionBegin;
import static com.airlenet.yang.compiler.translator.tojava.utils.StringGenerator.getExceptionThrowString;
import static com.airlenet.yang.compiler.translator.tojava.utils.StringGenerator.getForLoopString;
import static com.airlenet.yang.compiler.translator.tojava.utils.StringGenerator.getGreaterThanCondition;
import static com.airlenet.yang.compiler.translator.tojava.utils.StringGenerator.getIfConditionBegin;
import static com.airlenet.yang.compiler.translator.tojava.utils.StringGenerator.getLeafFlagSetString;
import static com.airlenet.yang.compiler.translator.tojava.utils.StringGenerator.getLesserThanCondition;
import static com.airlenet.yang.compiler.translator.tojava.utils.StringGenerator.getListAttribute;
import static com.airlenet.yang.compiler.translator.tojava.utils.StringGenerator.getNewInstance;
import static com.airlenet.yang.compiler.translator.tojava.utils.StringGenerator.getNewLineAndSpace;
import static com.airlenet.yang.compiler.translator.tojava.utils.StringGenerator.getOpenCloseParaWithValue;
import static com.airlenet.yang.compiler.translator.tojava.utils.StringGenerator.getOverRideString;
import static com.airlenet.yang.compiler.translator.tojava.utils.StringGenerator.getParseFromStringMethod;
import static com.airlenet.yang.compiler.translator.tojava.utils.StringGenerator.getPatternQuoteString;
import static com.airlenet.yang.compiler.translator.tojava.utils.StringGenerator.getQuotedString;
import static com.airlenet.yang.compiler.translator.tojava.utils.StringGenerator.getReturnOfSubString;
import static com.airlenet.yang.compiler.translator.tojava.utils.StringGenerator.getReturnString;
import static com.airlenet.yang.compiler.translator.tojava.utils.StringGenerator.getSetValueParaCondition;
import static com.airlenet.yang.compiler.translator.tojava.utils.StringGenerator.getSetterInterfaceString;
import static com.airlenet.yang.compiler.translator.tojava.utils.StringGenerator.getStringBuilderAttr;
import static com.airlenet.yang.compiler.translator.tojava.utils.StringGenerator.getToStringCall;
import static com.airlenet.yang.compiler.translator.tojava.utils.StringGenerator.getTrySubString;
import static com.airlenet.yang.compiler.translator.tojava.utils.StringGenerator.getTwoParaEqualsString;
import static com.airlenet.yang.compiler.translator.tojava.utils.StringGenerator.ifAndAndCondition;
import static com.airlenet.yang.compiler.translator.tojava.utils.StringGenerator.ifConditionForIntInTypeDefConstructor;
import static com.airlenet.yang.compiler.translator.tojava.utils.StringGenerator.ifEqualEqualCondition;
import static com.airlenet.yang.compiler.translator.tojava.utils.StringGenerator.methodBody;
import static com.airlenet.yang.compiler.translator.tojava.utils.StringGenerator.methodClose;
import static com.airlenet.yang.compiler.translator.tojava.utils.StringGenerator.methodSignature;
import static com.airlenet.yang.compiler.translator.tojava.utils.StringGenerator.methodSignatureClose;
import static com.airlenet.yang.compiler.translator.tojava.utils.StringGenerator.multiAttrMethodSignature;
import static com.airlenet.yang.compiler.translator.tojava.utils.StringGenerator.signatureClose;
import static com.airlenet.yang.compiler.translator.tojava.utils.StringGenerator.valueAssign;
import static com.airlenet.yang.compiler.translator.tojava.utils.TranslatorUtils.getEnumYangName;
import static com.airlenet.yang.compiler.translator.tojava.utils.TranslatorUtils.getIdentityRefName;
import static com.airlenet.yang.compiler.utils.UtilConstants.ADD;
import static com.airlenet.yang.compiler.utils.UtilConstants.ADD_AUGMENTATION;
import static com.airlenet.yang.compiler.utils.UtilConstants.ADD_STRING;
import static com.airlenet.yang.compiler.utils.UtilConstants.AND;
import static com.airlenet.yang.compiler.utils.UtilConstants.APPEND;
import static com.airlenet.yang.compiler.utils.UtilConstants.ARRAY_LIST_INIT;
import static com.airlenet.yang.compiler.utils.UtilConstants.AUGMENTATION;
import static com.airlenet.yang.compiler.utils.UtilConstants.AUGMENTATIONS;
import static com.airlenet.yang.compiler.utils.UtilConstants.AUGMENTED;
...
import static com.airlenet.yang.compiler.utils.UtilConstants.BITS;
...
import static com.airlenet.yang.compiler.utils.UtilConstants.CAMEL_CLASS;
import static com.airlenet.yang.compiler.utils.UtilConstants.CASE;
import static com.airlenet.yang.compiler.utils.UtilConstants.CLASS;
import static com.airlenet.yang.compiler.utils.UtilConstants.CLASS_STRING;
import static com.airlenet.yang.compiler.utils.UtilConstants.CLOSE_CURLY_BRACKET;
...
import static com.airlenet.yang.compiler.utils.UtilConstants.DECODE;
import static com.airlenet.yang.compiler.utils.UtilConstants.EIGHT_SPACE_INDENTATION;
import static com.airlenet.yang.compiler.utils.UtilConstants.ELSE;
import static com.airlenet.yang.compiler.utils.UtilConstants.EMPTY_STRING;
import static com.airlenet.yang.compiler.utils.UtilConstants.ENCODE_TO_STRING;
import static com.airlenet.yang.compiler.utils.UtilConstants.ENUM;
import static com.airlenet.yang.compiler.utils.UtilConstants.EQUAL;
import static com.airlenet.yang.compiler.utils.UtilConstants.EQUALS_STRING;
import static com.airlenet.yang.compiler.utils.UtilConstants.EXTEND;
import static com.airlenet.yang.compiler.utils.UtilConstants.FALSE;
import static com.airlenet.yang.compiler.utils.UtilConstants.FOR;
import static com.airlenet.yang.compiler.utils.UtilConstants.FOR_TYPE_STRING;
import static com.airlenet.yang.compiler.utils.UtilConstants.FOUR_SPACE_INDENTATION;
import static com.airlenet.yang.compiler.utils.UtilConstants.FROM_STRING_METHOD_NAME;
import static com.airlenet.yang.compiler.utils.UtilConstants.FROM_STRING_PARAM_NAME;
import static com.airlenet.yang.compiler.utils.UtilConstants.GET;
import static com.airlenet.yang.compiler.utils.UtilConstants.GET_DECODER;
import static com.airlenet.yang.compiler.utils.UtilConstants.GET_ENCODER;
import static com.airlenet.yang.compiler.utils.UtilConstants.GET_METHOD_PREFIX;
import static com.airlenet.yang.compiler.utils.UtilConstants.HASH;
import static com.airlenet.yang.compiler.utils.UtilConstants.HASH_CODE_STRING;
import static com.airlenet.yang.compiler.utils.UtilConstants.IDENTITY;
import static com.airlenet.yang.compiler.utils.UtilConstants.IF;
import static com.airlenet.yang.compiler.utils.UtilConstants.IMPLEMENTS;
import static com.airlenet.yang.compiler.utils.UtilConstants.INSTANCE_OF;
import static com.airlenet.yang.compiler.utils.UtilConstants.INT;
import static com.airlenet.yang.compiler.utils.UtilConstants.IS_EMPTY;
import static com.airlenet.yang.compiler.utils.UtilConstants.KEYS;
import static com.airlenet.yang.compiler.utils.UtilConstants.LEAF;
import static com.airlenet.yang.compiler.utils.UtilConstants.LEAF_IDENTIFIER;
import static com.airlenet.yang.compiler.utils.UtilConstants.LEFT_ANGULAR_BRACKET;
import static com.airlenet.yang.compiler.utils.UtilConstants.LINKED_HASH_MAP;
import static com.airlenet.yang.compiler.utils.UtilConstants.LINKED_HASH_SET;
import static com.airlenet.yang.compiler.utils.UtilConstants.LONG;
import static com.airlenet.yang.compiler.utils.UtilConstants.MAP;
import static com.airlenet.yang.compiler.utils.UtilConstants.MAX_RANGE;
import static com.airlenet.yang.compiler.utils.UtilConstants.MIN_RANGE;
import static com.airlenet.yang.compiler.utils.UtilConstants.MODEL_LEAF_IDENTIFIER;
import static com.airlenet.yang.compiler.utils.UtilConstants.MODEL_OBJECT;
import static com.airlenet.yang.compiler.utils.UtilConstants.NEW;
import static com.airlenet.yang.compiler.utils.UtilConstants.NEW_LINE;
import static com.airlenet.yang.compiler.utils.UtilConstants.NEW_STRING_JOINER_OBJECT;
import static com.airlenet.yang.compiler.utils.UtilConstants.NOT;
import static com.airlenet.yang.compiler.utils.UtilConstants.NULL;
import static com.airlenet.yang.compiler.utils.UtilConstants.OBJ;
import static com.airlenet.yang.compiler.utils.UtilConstants.OBJECT_STRING;
import static com.airlenet.yang.compiler.utils.UtilConstants.OF;
import static com.airlenet.yang.compiler.utils.UtilConstants.OF_CAPS;
import static com.airlenet.yang.compiler.utils.UtilConstants.ONE;
import static com.airlenet.yang.compiler.utils.UtilConstants.OPEN_CLOSE_BRACKET_STRING;
import static com.airlenet.yang.compiler.utils.UtilConstants.OPEN_CURLY_BRACKET;
import static com.airlenet.yang.compiler.utils.UtilConstants.OPEN_PARENTHESIS;
import static com.airlenet.yang.compiler.utils.UtilConstants.OPERATION_TYPE_ATTRIBUTE;
import static com.airlenet.yang.compiler.utils.UtilConstants.OP_PARAM;
import static com.airlenet.yang.compiler.utils.UtilConstants.OTHER;
import static com.airlenet.yang.compiler.utils.UtilConstants.PERIOD;
import static com.airlenet.yang.compiler.utils.UtilConstants.PRIORITY_QUEUE;
import static com.airlenet.yang.compiler.utils.UtilConstants.PRIVATE;
import static com.airlenet.yang.compiler.utils.UtilConstants.PUBLIC;
import static com.airlenet.yang.compiler.utils.UtilConstants.PUT;
import static com.airlenet.yang.compiler.utils.UtilConstants.QUESTION_MARK;
import static com.airlenet.yang.compiler.utils.UtilConstants.QUOTES;
import static com.airlenet.yang.compiler.utils.UtilConstants.REMOVE_AUGMENTATION;
import static com.airlenet.yang.compiler.utils.UtilConstants.RETURN;
import static com.airlenet.yang.compiler.utils.UtilConstants.RIGHT_ANGULAR_BRACKET;
import static com.airlenet.yang.compiler.utils.UtilConstants.RPC_INPUT_VAR_NAME;
import static com.airlenet.yang.compiler.utils.UtilConstants.SCHEMA_NAME;
import static com.airlenet.yang.compiler.utils.UtilConstants.SEMI_COLON;
import static com.airlenet.yang.compiler.utils.UtilConstants.SET_METHOD_PREFIX;
import static com.airlenet.yang.compiler.utils.UtilConstants.SET_VALUE_PARA;
import static com.airlenet.yang.compiler.utils.UtilConstants.SIXTEEN_SPACE_INDENTATION;
import static com.airlenet.yang.compiler.utils.UtilConstants.SPACE;
import static com.airlenet.yang.compiler.utils.UtilConstants.SPLIT_STRING;
import static com.airlenet.yang.compiler.utils.UtilConstants.SQUARE_BRACKETS;
import static com.airlenet.yang.compiler.utils.UtilConstants.STATIC;
import static com.airlenet.yang.compiler.utils.UtilConstants.STRING_BUILDER_VAR;
import static com.airlenet.yang.compiler.utils.UtilConstants.STRING_DATA_TYPE;
import static com.airlenet.yang.compiler.utils.UtilConstants.SUFFIX_S;
import static com.airlenet.yang.compiler.utils.UtilConstants.SWITCH;
import static com.airlenet.yang.compiler.utils.UtilConstants.TEMPLATE_T;
import static com.airlenet.yang.compiler.utils.UtilConstants.THIS;
import static com.airlenet.yang.compiler.utils.UtilConstants.TMP_VAL;
import static com.airlenet.yang.compiler.utils.UtilConstants.TO_CAPS;
import static com.airlenet.yang.compiler.utils.UtilConstants.TO_STRING_METHOD;
import static com.airlenet.yang.compiler.utils.UtilConstants.TRIM_STRING;
import static com.airlenet.yang.compiler.utils.UtilConstants.TRUE;
import static com.airlenet.yang.compiler.utils.UtilConstants.TWELVE_SPACE_INDENTATION;
import static com.airlenet.yang.compiler.utils.UtilConstants.VALIDATE_RANGE;
import static com.airlenet.yang.compiler.utils.UtilConstants.VALUE;
import static com.airlenet.yang.compiler.utils.UtilConstants.VALUE_CAPS;
import static com.airlenet.yang.compiler.utils.UtilConstants.VALUE_LEAF;
import static com.airlenet.yang.compiler.utils.UtilConstants.VALUE_LEAF_SET;
import static com.airlenet.yang.compiler.utils.UtilConstants.VARIABLE_C;
import static com.airlenet.yang.compiler.utils.UtilConstants.VOID;
...
import static com.airlenet.yang.compiler.utils.io.impl.JavaDocGen.JavaDocType.FROM_METHOD;
import static com.airlenet.yang.compiler.utils.io.impl.JavaDocGen.JavaDocType.GETTER_METHOD;
import static com.airlenet.yang.compiler.utils.io.impl.JavaDocGen.JavaDocType.MANAGER_SETTER_METHOD;
import static com.airlenet.yang.compiler.utils.io.impl.JavaDocGen.JavaDocType.OF_METHOD;
import static com.airlenet.yang.compiler.utils.io.impl.JavaDocGen.JavaDocType.SETTER_METHOD;
import static com.airlenet.yang.compiler.utils.io.impl.JavaDocGen.JavaDocType.TYPE_CONSTRUCTOR;
import static com.airlenet.yang.compiler.utils.io.impl.JavaDocGen.generateForGetMethodWithAttribute;
import static com.airlenet.yang.compiler.utils.io.impl.JavaDocGen.generateForValidatorMethod;
...
import static com.airlenet.yang.compiler.utils.io.impl.YangIoUtils.getSmallCase;
