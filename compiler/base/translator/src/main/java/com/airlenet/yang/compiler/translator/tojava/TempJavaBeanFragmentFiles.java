...
import com.airlenet.yang.compiler.translator.tojava.utils.MethodsGenerator;
...
public class TempJavaBeanFragmentFiles
    ...
    TempJavaBeanFragmentFiles(JavaFileInfoTranslator javaFileInfo)
         ...
         */
        addGeneratedTempFile(GeneratedTempFileType.CONSTRUCTOR_IMPL_MASK);
    ...
    private void addConstructor(JavaAttributeInfo attr)
        ...
        appendToFile(constructorImplTempFileHandle,
                     MethodsGenerator.getConstructor(attr, getGeneratedJavaFiles()));
    }
