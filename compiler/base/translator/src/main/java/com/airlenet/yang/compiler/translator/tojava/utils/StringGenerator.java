...
import static com.airlenet.yang.compiler.datamodel.utils.builtindatatype.YangDataTypes.DECIMAL64;
...
import static com.airlenet.yang.compiler.datamodel.utils.builtindatatype.YangDataTypes.UINT64;
...
import static com.airlenet.yang.compiler.utils.UtilConstants.ABSTRACT;
...
import static com.airlenet.yang.compiler.utils.UtilConstants.APP_INSTANCE;
import static com.airlenet.yang.compiler.utils.UtilConstants.AT;
...
import static com.airlenet.yang.compiler.utils.UtilConstants.BITSET;
...
import static com.airlenet.yang.compiler.utils.UtilConstants.CATCH;
import static com.airlenet.yang.compiler.utils.UtilConstants.CHECK_NOT_NULL_STRING;
...
import static com.airlenet.yang.compiler.utils.UtilConstants.DOUBLE;
...
import static com.airlenet.yang.compiler.utils.UtilConstants.EXCEPTION;
import static com.airlenet.yang.compiler.utils.UtilConstants.EXCEPTION_STRING;
import static com.airlenet.yang.compiler.utils.UtilConstants.EXCEPTION_VAR;
...
import static com.airlenet.yang.compiler.utils.UtilConstants.IMPORT;
...
import static com.airlenet.yang.compiler.utils.UtilConstants.INT_MAX_RANGE;
import static com.airlenet.yang.compiler.utils.UtilConstants.INT_MIN_RANGE;
...
import static com.airlenet.yang.compiler.utils.UtilConstants.LIST;
import static com.airlenet.yang.compiler.utils.UtilConstants.LONG;
import static com.airlenet.yang.compiler.utils.UtilConstants.LONG_MAX_RANGE;
import static com.airlenet.yang.compiler.utils.UtilConstants.LONG_MIN_RANGE;
...
import static com.airlenet.yang.compiler.utils.UtilConstants.OBJECT;
import static com.airlenet.yang.compiler.utils.UtilConstants.OF;
import static com.airlenet.yang.compiler.utils.UtilConstants.OMIT_NULL_VALUE_STRING;
...
import static com.airlenet.yang.compiler.utils.UtilConstants.OVERRIDE;
import static com.airlenet.yang.compiler.utils.UtilConstants.PARSE_BOOLEAN;
import static com.airlenet.yang.compiler.utils.UtilConstants.PARSE_BYTE;
import static com.airlenet.yang.compiler.utils.UtilConstants.PARSE_INT;
import static com.airlenet.yang.compiler.utils.UtilConstants.PARSE_LONG;
import static com.airlenet.yang.compiler.utils.UtilConstants.PARSE_SHORT;
import static com.airlenet.yang.compiler.utils.UtilConstants.PATTERN;
import static com.airlenet.yang.compiler.utils.UtilConstants.PERIOD;
import static com.airlenet.yang.compiler.utils.UtilConstants.QUEUE;
import static com.airlenet.yang.compiler.utils.UtilConstants.QUOTES;
import static com.airlenet.yang.compiler.utils.UtilConstants.QUOTE_STRING;
...
import static com.airlenet.yang.compiler.utils.UtilConstants.SET;
...
import static com.airlenet.yang.compiler.utils.UtilConstants.SHORT_MAX_RANGE;
import static com.airlenet.yang.compiler.utils.UtilConstants.SHORT_MIN_RANGE;
...
import static com.airlenet.yang.compiler.utils.UtilConstants.STRING_BUILDER;
...
import static com.airlenet.yang.compiler.utils.UtilConstants.THROW_NEW;
...
import static com.airlenet.yang.compiler.utils.UtilConstants.TRY;
import static com.airlenet.yang.compiler.utils.UtilConstants.TWELVE_SPACE_INDENTATION;
import static com.airlenet.yang.compiler.utils.UtilConstants.TWENTY_SPACE_INDENTATION;
import static com.airlenet.yang.compiler.utils.UtilConstants.UINT8_MAX_RANGE;
import static com.airlenet.yang.compiler.utils.UtilConstants.UINT8_MIN_RANGE;
import static com.airlenet.yang.compiler.utils.UtilConstants.UINT_MAX_RANGE;
import static com.airlenet.yang.compiler.utils.UtilConstants.UINT_MIN_RANGE;
import static com.airlenet.yang.compiler.utils.UtilConstants.ULONG_MAX_RANGE;
import static com.airlenet.yang.compiler.utils.UtilConstants.ULONG_MIN_RANGE;
...
import static com.airlenet.yang.compiler.utils.UtilConstants.YANG_UTILS_TODO;
...
public final class StringGenerator {
        ...
        switch (type) {
            ...
            case CONSTRUCTOR:
                return space + paraName + SPACE +
                        ...
                        prefix + methodName +
                        brackets(BracketType.OPEN_CLOSE_BRACKET, null, null) +
                        signatureClose();
    ...
    public static String methodSignature(
        ...
        if (paraVal != null) {
            methodBuilder.append(brackets(
                    BracketType.OPEN_CLOSE_BRACKET_WITH_VALUE_AND_RETURN_TYPE,
                    paraVal, paraReturnType));
        } else {
            methodBuilder.append(brackets(BracketType.OPEN_CLOSE_BRACKET, null,
                                          null));
        }
    ...
    static String getListAttribute(String attrType,
        ...
        String listAttr;
        YangDataStructure ds = JavaFileGeneratorUtils.getYangDataStructure(compilerAnnotation);
        if (ds != null) {
            switch (ds) {
                case QUEUE: {
        ...
        switch (type) {
            ...
            case IDENTITYREF:
                return getCapitalCase(getCamelCase(
                        TranslatorUtils.getIdentityRefName(yangType), null))
    ...
    static String getCatchSubString(String attrHolder) {
        ...
        builder.append(CLOSE_CURLY_BRACKET).append(SPACE).append(CATCH)
                .append(SPACE).append(
                brackets(BracketType.OPEN_CLOSE_BRACKET_WITH_VALUE_AND_RETURN_TYPE, EXCEPTION_VAR,
    ...
    static String getIfConditionBegin(String indentation, String condition) {
        return indentation + IF + SPACE + getOpenCloseParaWithValue(condition) +
                methodSignatureClose(MethodClassTypes.CLASS_TYPE);
    }
    ...
    static String getOpenCloseParaWithValue(String name) {
        return brackets(BracketType.OPEN_CLOSE_BRACKET_WITH_VALUE, name, null);
    }
    ...
    static String getSetterInterfaceString(String name,
        ...
        if (genType == GENERATE_SERVICE_AND_MANAGER) {
            return methodSignature(getCapitalCase(attrName), SET_METHOD_PREFIX,
                                   ...
                                   MethodClassTypes.INTERFACE_TYPE);
        }
        return methodSignature(attrName, EMPTY_STRING, null,
                               attrName, VOID, attrType, MethodClassTypes.INTERFACE_TYPE);
    }
}
