/* 
 * @(#)AuthenticationCallback.java        1.0
 *
...
import com.airlenet.yang.model.tailfConfdMonitoring.confdState.internal.callpoints.authenticationCallback.Daemon;
import com.airlenet.yang.model.tailfConfdMonitoring.confdState.internal.callpoints.authenticationCallback.Range;
 ...
 * generated to "src/main/java/com.airlenet.yang.model/tailfConfdMonitoring/confdState/internal/callpoints/authentication-callback"
 * <p>
 * See line 563 in
 ...
 */
public class AuthenticationCallback extends YangElement {
     ...
     */
    public com.airlenet.yang.model.tailfConfdMonitoring.confdState.internal.callpoints.authenticationCallback.Daemon daemon = null;
    public com.airlenet.yang.model.tailfConfdMonitoring.confdState.internal.callpoints.authenticationCallback.Daemon getDaemon() {
        return this.daemon;
    }

    /**
     * Constructor for an empty AuthenticationCallback object.
     */
    public AuthenticationCallback() {
        super(TfcgPrefix.NAMESPACE, "authentication-callback");
    }
     ...
     */
    public AuthenticationCallback clone() {
        return (AuthenticationCallback)cloneContent(new AuthenticationCallback());
    }
     ...
     */
    public AuthenticationCallback cloneShallow() {
        return (AuthenticationCallback)cloneShallowContent(new AuthenticationCallback());
    }
     ...
     */
    public com.tailf.jnc.YangBoolean getEnabledValue() throws JNCException {
        return (com.tailf.jnc.YangBoolean)getValue("enabled");
    }
     ...
     */
    public void setEnabledValue(com.tailf.jnc.YangBoolean enabledValue)
            throws JNCException {
    ...
    public void setEnabledValue(Boolean enabledValue) throws JNCException {
        setEnabledValue(new com.tailf.jnc.YangBoolean(enabledValue));
    }
    ...
    /**
     * Marks the leaf "enabled" with operation "remove".
     */
    public void markEnabledRemove() throws JNCException {
        markLeafRemove("enabled");
    }
