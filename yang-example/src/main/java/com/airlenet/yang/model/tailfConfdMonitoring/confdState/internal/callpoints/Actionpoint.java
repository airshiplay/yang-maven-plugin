...
import com.airlenet.yang.model.tailfConfdMonitoring.confdState.internal.callpoints.actionpoint.Daemon;
import com.airlenet.yang.model.tailfConfdMonitoring.confdState.internal.callpoints.actionpoint.Range;
 ...
 * generated to "src/main/java/com.airlenet.yang.model/tailfConfdMonitoring/confdState/internal/callpoints/actionpoint"
 * <p>
 * See line 521 in
 ...
 */
public class Actionpoint extends YangElement {
     ...
     */
    public com.airlenet.yang.model.tailfConfdMonitoring.confdState.internal.callpoints.actionpoint.Daemon daemon = null;
    public com.airlenet.yang.model.tailfConfdMonitoring.confdState.internal.callpoints.actionpoint.Daemon getDaemon() {
        return this.daemon;
    }

    /**
     * Constructor for an empty Actionpoint object.
     */
    public Actionpoint() {
        super(TfcgPrefix.NAMESPACE, "actionpoint");
    }
    ...
    public Actionpoint clone() {
        return (Actionpoint)cloneContent(new Actionpoint());
    }
     ...
     */
    public Actionpoint cloneShallow() {
        return (Actionpoint)cloneShallowContent(new Actionpoint());
    }
