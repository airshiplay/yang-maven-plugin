/* 
 * @(#)ErrorFormattingCallback.java        1.0
 *
...
import com.airlenet.yang.model.tailfConfdMonitoring.confdState.internal.callpoints.errorFormattingCallback.Daemon;
import com.airlenet.yang.model.tailfConfdMonitoring.confdState.internal.callpoints.errorFormattingCallback.Range;
 ...
 * generated to "src/main/java/com.airlenet.yang.model/tailfConfdMonitoring/confdState/internal/callpoints/error-formatting-callback"
 * <p>
 * See line 536 in
 ...
 */
public class ErrorFormattingCallback extends YangElement {
     ...
     */
    public com.airlenet.yang.model.tailfConfdMonitoring.confdState.internal.callpoints.errorFormattingCallback.Daemon daemon = null;
    public com.airlenet.yang.model.tailfConfdMonitoring.confdState.internal.callpoints.errorFormattingCallback.Daemon getDaemon() {
        return this.daemon;
    }

    /**
     * Constructor for an empty ErrorFormattingCallback object.
     */
    public ErrorFormattingCallback() {
        super(TfcgPrefix.NAMESPACE, "error-formatting-callback");
    }
     ...
     */
    public ErrorFormattingCallback clone() {
        return (ErrorFormattingCallback)cloneContent(new ErrorFormattingCallback());
    }
     ...
     */
    public ErrorFormattingCallback cloneShallow() {
        return (ErrorFormattingCallback)cloneShallowContent(new ErrorFormattingCallback());
    }
