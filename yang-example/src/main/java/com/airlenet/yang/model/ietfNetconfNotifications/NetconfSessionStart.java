 ...
 * generated to "src/main/java/com.airlenet.yang.model/ietfNetconfNotifications/netconf-session-start"
 * <p>
 * See line 203 in
 ...
 */
public class NetconfSessionStart extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty NetconfSessionStart object.
     */
    public NetconfSessionStart() {
        super(NcnPrefix.NAMESPACE, "netconf-session-start");
        setDefaultPrefix();
     ...
     */
    public NetconfSessionStart clone() {
        return (NetconfSessionStart)cloneContent(new NetconfSessionStart());
    }
     ...
     */
    public NetconfSessionStart cloneShallow() {
        return (NetconfSessionStart)cloneShallowContent(new NetconfSessionStart());
    }
