...
/**
 * The root class for namespace urn:ietf:params:xml:ns:netconf:base:1.0 (accessible from 
 * IetfNetconf.NAMESPACE) with prefix "ncPrefix" (IetfNetconf.PREFIX).
 *
 * @version 1.0
 * @author Auto Generated
 */
public class NcPrefix {
    ...
    public static void enable() throws JNCException {
        YangElement.setPackage(NAMESPACE, "com.airlenet.yang.model.ietfNetconf");
        NcPrefix.registerSchema();
    }
    ...
    public static void registerSchema() throws JNCException {
        ...
        parser.findAndReadFile("NcPrefix.schema", h, NcPrefix.class);
    }
