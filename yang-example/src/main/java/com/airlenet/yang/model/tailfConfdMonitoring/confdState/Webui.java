...
import com.airlenet.yang.model.tailfConfdMonitoring.confdState.webui.Listen;
 ...
 * generated to "src/main/java/com.airlenet.yang.model/tailfConfdMonitoring/confdState/webui"
 * <p>
 * See line 424 in
...
public class Webui extends YangElement {
     ...
     */
    public Webui() {
        super(TfcgPrefix.NAMESPACE, "webui");
        setDefaultPrefix();
