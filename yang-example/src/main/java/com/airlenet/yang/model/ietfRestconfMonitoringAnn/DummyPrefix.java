 ...
 * Origin: module "ietf-restconf-monitoring-ann", revision: "unknown".
 */
 ...
 * IetfRestconfMonitoringAnn.NAMESPACE) with prefix "dummyPrefix" (IetfRestconfMonitoringAnn.PREFIX).
 *
 * @version 1.0
...
public class DummyPrefix {
    ...
    public static void enable() throws JNCException {
        YangElement.setPackage(NAMESPACE, "com.airlenet.yang.model.ietfRestconfMonitoringAnn");
