...
import com.airlenet.yang.model.tailfConfdMonitoring.confdState.internal.callpoints.snmpInformCallback.Daemon;
import com.airlenet.yang.model.tailfConfdMonitoring.confdState.internal.callpoints.snmpInformCallback.Range;
 ...
 * generated to "src/main/java/com.airlenet.yang.model/tailfConfdMonitoring/confdState/internal/callpoints/snmp-inform-callback"
 * <p>
 * See line 526 in
 ...
 */
public class SnmpInformCallback extends YangElement {
     ...
     */
    public com.airlenet.yang.model.tailfConfdMonitoring.confdState.internal.callpoints.snmpInformCallback.Daemon daemon = null;
    public com.airlenet.yang.model.tailfConfdMonitoring.confdState.internal.callpoints.snmpInformCallback.Daemon getDaemon() {
        return this.daemon;
    }

    /**
     * Constructor for an empty SnmpInformCallback object.
     */
    public SnmpInformCallback() {
        super(TfcgPrefix.NAMESPACE, "snmp-inform-callback");
    }
     ...
     */
    public SnmpInformCallback clone() {
        return (SnmpInformCallback)cloneContent(new SnmpInformCallback());
    }
     ...
     */
    public SnmpInformCallback cloneShallow() {
        return (SnmpInformCallback)cloneShallowContent(new SnmpInformCallback());
    }
