 ...
 * generated to "src/main/java/com.airlenet.yang.model/tailfConfdMonitoring/confdState/webui/listen/tcp"
 * <p>
 * See line 430 in
 ...
 */
public class Tcp extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty Tcp object.
     */
    public Tcp() {
        super(TfcgPrefix.NAMESPACE, "tcp");
    }
     ...
     */
    public Tcp clone() {
        return (Tcp)cloneContent(new Tcp());
    }
     ...
     */
    public Tcp cloneShallow() {
        return (Tcp)cloneShallowContent(new Tcp());
    }
