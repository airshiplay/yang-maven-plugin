/* 
 * @(#)SnmpNotificationSubscription.java        1.0
 *
...
import com.airlenet.yang.model.tailfConfdMonitoring.confdState.internal.callpoints.snmpNotificationSubscription.Daemon;
import com.airlenet.yang.model.tailfConfdMonitoring.confdState.internal.callpoints.snmpNotificationSubscription.Range;
 ...
 * generated to "src/main/java/com.airlenet.yang.model/tailfConfdMonitoring/confdState/internal/callpoints/snmp-notification-subscription"
 * <p>
 * See line 531 in
 ...
 */
public class SnmpNotificationSubscription extends YangElement {
     ...
     */
    public com.airlenet.yang.model.tailfConfdMonitoring.confdState.internal.callpoints.snmpNotificationSubscription.Daemon daemon = null;
    public com.airlenet.yang.model.tailfConfdMonitoring.confdState.internal.callpoints.snmpNotificationSubscription.Daemon getDaemon() {
        return this.daemon;
    }

    /**
     * Constructor for an empty SnmpNotificationSubscription object.
     */
    public SnmpNotificationSubscription() {
        super(TfcgPrefix.NAMESPACE, "snmp-notification-subscription");
    }
     ...
     */
    public SnmpNotificationSubscription clone() {
        return (SnmpNotificationSubscription)cloneContent(new SnmpNotificationSubscription());
    }
     ...
     */
    public SnmpNotificationSubscription cloneShallow() {
        return (SnmpNotificationSubscription)cloneShallowContent(new SnmpNotificationSubscription());
    }
