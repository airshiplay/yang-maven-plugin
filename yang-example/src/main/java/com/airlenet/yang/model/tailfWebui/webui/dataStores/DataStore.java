 ...
 * generated to "src/main/java/com.airlenet.yang.model/tailfWebui/webui/dataStores/data-store"
 * <p>
 * See line 176 in
...
public class DataStore extends YangElement {
     ...
     */
    public DataStore() {
        super(WebuiPrefix.NAMESPACE, "data-store");
    }

    /**
     * Constructor for an initialized DataStore object,
     * 
     * @param keyValue Key argument of child.
     */
    public DataStore(YangString keyValue) throws JNCException {
        super(WebuiPrefix.NAMESPACE, "data-store");
     ...
     * @param keyValue Key argument of child.
     */
    public DataStore(String keyValue) throws JNCException {
        super(WebuiPrefix.NAMESPACE, "data-store");
        Leaf key = new Leaf(WebuiPrefix.NAMESPACE, "key");
    ...
    public DataStore clone() {
        DataStore copy;
        try {
            copy = new DataStore(getKeyValue().toString());
        } catch (JNCException e) {
            copy = null;
        }
        return (DataStore)cloneContent(copy);
    }
    ...
    public DataStore cloneShallow() {
        ...
        return (DataStore)cloneShallowContent(copy);
    }
