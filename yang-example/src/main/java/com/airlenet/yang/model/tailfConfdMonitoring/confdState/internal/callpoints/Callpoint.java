...
import com.airlenet.yang.model.tailfConfdMonitoring.confdState.internal.callpoints.callpoint.Daemon;
import com.airlenet.yang.model.tailfConfdMonitoring.confdState.internal.callpoints.callpoint.Range;
 ...
 * generated to "src/main/java/com.airlenet.yang.model/tailfConfdMonitoring/confdState/internal/callpoints/callpoint"
 * <p>
 * See line 511 in
 ...
 */
public class Callpoint extends YangElement {
     ...
     */
    public com.airlenet.yang.model.tailfConfdMonitoring.confdState.internal.callpoints.callpoint.Daemon daemon = null;
    public com.airlenet.yang.model.tailfConfdMonitoring.confdState.internal.callpoints.callpoint.Daemon getDaemon() {
        return this.daemon;
    }

    /**
     * Constructor for an empty Callpoint object.
     */
    public Callpoint() {
        super(TfcgPrefix.NAMESPACE, "callpoint");
    }
     ...
     */
    public Callpoint clone() {
        return (Callpoint)cloneContent(new Callpoint());
    }
     ...
     */
    public Callpoint cloneShallow() {
        return (Callpoint)cloneShallowContent(new Callpoint());
    }
