...
import com.airlenet.yang.model.tailfConfdMonitoring.confdState.cli.Listen;
 ...
 * generated to "src/main/java/com.airlenet.yang.model/tailfConfdMonitoring/confdState/cli"
 * <p>
 * See line 401 in
 ...
 */
public class Cli extends YangElement {
    ...
    /**
     * Constructor for an empty Cli object.
     */
    public Cli() {
        super(TfcgPrefix.NAMESPACE, "cli");
        setDefaultPrefix();
     ...
     */
    public Cli clone() {
        return (Cli)cloneContent(new Cli());
    }
     ...
     */
    public Cli cloneShallow() {
        return (Cli)cloneShallowContent(new Cli());
    }
