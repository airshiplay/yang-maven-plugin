/* 
 * @(#)AuthorizationCallbacks.java        1.0
 *
...
import com.airlenet.yang.model.tailfConfdMonitoring.confdState.internal.callpoints.authorizationCallbacks.Daemon;
import com.airlenet.yang.model.tailfConfdMonitoring.confdState.internal.callpoints.authorizationCallbacks.Range;
 ...
 * generated to "src/main/java/com.airlenet.yang.model/tailfConfdMonitoring/confdState/internal/callpoints/authorization-callbacks"
 * <p>
 * See line 572 in
 ...
 */
public class AuthorizationCallbacks extends YangElement {
     ...
     */
    public com.airlenet.yang.model.tailfConfdMonitoring.confdState.internal.callpoints.authorizationCallbacks.Daemon daemon = null;
    public com.airlenet.yang.model.tailfConfdMonitoring.confdState.internal.callpoints.authorizationCallbacks.Daemon getDaemon() {
        return this.daemon;
    }

    /**
     * Constructor for an empty AuthorizationCallbacks object.
     */
    public AuthorizationCallbacks() {
        super(TfcgPrefix.NAMESPACE, "authorization-callbacks");
    }
     ...
     */
    public AuthorizationCallbacks clone() {
        return (AuthorizationCallbacks)cloneContent(new AuthorizationCallbacks());
    }
     ...
     */
    public AuthorizationCallbacks cloneShallow() {
        return (AuthorizationCallbacks)cloneShallowContent(new AuthorizationCallbacks());
    }
