 ...
 * Origin: module "tailf-common-monitoring-ann", revision: "unknown".
 */
...
/**
 * The root class for namespace urn:dummy-common (accessible from 
 * TailfCommonMonitoringAnn.NAMESPACE) with prefix "dummyPrefix" (TailfCommonMonitoringAnn.PREFIX).
 *
 * @version 1.0
...
public class DummyPrefix {
    ...
    public static final String NAMESPACE = "urn:dummy-common";
    ...
    public static void enable() throws JNCException {
        YangElement.setPackage(NAMESPACE, "com.airlenet.yang.model.tailfCommonMonitoringAnn");
