 ...
 * Origin: module "ietf-netconf-notifications-ann", revision: "unknown".
 */
 ...
 * IetfNetconfNotificationsAnn.NAMESPACE) with prefix "dummyPrefix" (IetfNetconfNotificationsAnn.PREFIX).
 *
 * @version 1.0
...
public class DummyPrefix {
    ...
    public static void enable() throws JNCException {
        YangElement.setPackage(NAMESPACE, "com.airlenet.yang.model.ietfNetconfNotificationsAnn");
