 ...
 * Origin: module "ietf-netconf-acm-ann", revision: "unknown".
 */
 ...
 * IetfNetconfAcmAnn.NAMESPACE) with prefix "dummyPrefix" (IetfNetconfAcmAnn.PREFIX).
 *
 * @version 1.0
...
public class DummyPrefix {
    ...
    public static void enable() throws JNCException {
        YangElement.setPackage(NAMESPACE, "com.airlenet.yang.model.ietfNetconfAcmAnn");
