 ...
 * Origin: module "tailf-confd-monitoring-ann", revision: "unknown".
 */
 ...
 * TailfConfdMonitoringAnn.NAMESPACE) with prefix "dummyPrefix" (TailfConfdMonitoringAnn.PREFIX).
 *
 * @version 1.0
...
public class DummyPrefix {
    ...
    public static void enable() throws JNCException {
        YangElement.setPackage(NAMESPACE, "com.airlenet.yang.model.tailfConfdMonitoringAnn");
