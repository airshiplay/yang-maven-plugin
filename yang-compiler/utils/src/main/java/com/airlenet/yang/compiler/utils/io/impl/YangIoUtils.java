...
public final class YangIoUtils {
    ...
    public static void addPackageInfo(File path, String classInfo, String pack,
        ...
        try {
            ...
            bufferedWriter.write(JavaDocGen.getJavaDoc(JavaDocGen.JavaDocType.PACKAGE_INFO, classInfo, isChildNode,
                                            null));
    ...
    public static void addPackageInfo(File path, String classInfo, String pack,
                                      boolean isChildNode,String yangFileName,int lineNumber) throws IOException {
        ...
        try {
            ...
            bufferedWriter.write(CopyrightHeader.parseCopyrightHeader());
            //TODO: get the compiler annotations and pass the info
            String javaDoc = JavaDocGen.getJavaDoc(JavaDocGen.JavaDocType.PACKAGE_INFO, classInfo, isChildNode,
                    null);
    ...
    public static String parsePkg(String pack) {
        ...
        if (pack.contains(ORG)) {
            int indexOf = pack.indexOf(ORG);
            pack =pack.substring(indexOf);
