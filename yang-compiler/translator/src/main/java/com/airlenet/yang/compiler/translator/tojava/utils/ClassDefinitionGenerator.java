...
import static com.airlenet.yang.compiler.translator.tojava.utils.StringGenerator.getAbstractClassDefinitionWithExtends;
import static com.airlenet.yang.compiler.translator.tojava.utils.StringGenerator.getDefaultDefinition;
import static com.airlenet.yang.compiler.translator.tojava.utils.StringGenerator.getDefaultDefinitionWithExtends;
import static com.airlenet.yang.compiler.translator.tojava.utils.StringGenerator.getDefaultDefinitionWithImpl;
import static com.airlenet.yang.compiler.translator.tojava.utils.StringGenerator.getDefaultName;
import static com.airlenet.yang.compiler.translator.tojava.utils.StringGenerator.getDefinitionWithImplements;
import static com.airlenet.yang.compiler.translator.tojava.utils.StringGenerator.getErrorMsg;
import static com.airlenet.yang.compiler.translator.tojava.utils.StringGenerator.getEventExtendsString;
import static com.airlenet.yang.compiler.translator.tojava.utils.StringGenerator.getSpecificModifier;
import static com.airlenet.yang.compiler.translator.tojava.utils.StringGenerator.getSuffixedName;
import static com.airlenet.yang.compiler.utils.UtilConstants.ABSTRACT;
import static com.airlenet.yang.compiler.utils.UtilConstants.ABSTRACT_EVENT;
...
import static com.airlenet.yang.compiler.utils.UtilConstants.ERROR_MSG_JAVA_IDENTITY;
...
import static com.airlenet.yang.compiler.utils.UtilConstants.EVENT_TYPE;
import static com.airlenet.yang.compiler.utils.UtilConstants.EXTEND;
import static com.airlenet.yang.compiler.utils.UtilConstants.FINAL;
...
import static com.airlenet.yang.compiler.utils.UtilConstants.LISTENER_SERVICE;
...
import static com.airlenet.yang.compiler.utils.UtilConstants.REGEX_FOR_ANY_STRING_ENDING_WITH_SERVICE;
...
import static com.airlenet.yang.compiler.utils.UtilConstants.RPC_SERVICE;
...
import static com.airlenet.yang.compiler.utils.UtilConstants.SUBJECT;
...
final class ClassDefinitionGenerator {
    ...
    private static String getKeyClassDefinition(String yangName,
        ...
        String keyInfo = KEY_INFO +
                brackets(BracketType.OPEN_CLOSE_DIAMOND_WITH_VALUE,
        ...
        if (holder.getExtendsList() != null && !holder.getExtendsList()
            ...
            while (curNode != null) {
                if (curNode instanceof YangNotification) {
                    return getRpcInterfaceDefinitionWhenItExtends(yangFileName);
                }
    ...
    private static String getEventListenerDefinition(String javaName) {
        ...
        return getDefaultDefinitionWithExtends(
                INTERFACE, javaName, PUBLIC, EVENT_LISTENER_STRING +
                        brackets(BracketType.OPEN_CLOSE_DIAMOND_WITH_VALUE, name, null));
    }
