...
public class YangJavaModuleTranslator
    ...
    public void generateCodeEntry(YangPluginConfig yangPlugin)
        ...
        enabler.addLine("YangElement.setPackage(NAMESPACE,MODULE_NAME, REVISION,PACKAGE_NAME);");
        ...
        try {
            ...
            FileUtils.write(new File(fileInfo.getBaseCodeGenPath(), "yang.module"), getModuleNamespace() + "?module=" + getModuleName() + (rev == null ? "" : "&revision=" + rev)
                    + "\n", true);
        } catch (IOException e) {
