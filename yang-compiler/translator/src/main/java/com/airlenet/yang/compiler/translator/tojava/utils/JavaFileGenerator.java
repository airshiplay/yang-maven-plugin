...
import com.airlenet.yang.compiler.translator.tojava.JavaImportData;
...
import com.airlenet.yang.compiler.translator.tojava.TempJavaEnumerationFragmentFiles;
import com.airlenet.yang.compiler.translator.tojava.TempJavaEventFragmentFiles;
import com.airlenet.yang.compiler.translator.tojava.TempJavaServiceFragmentFiles;
import com.airlenet.yang.compiler.translator.tojava.TempJavaTypeFragmentFiles;
...
import static com.airlenet.yang.compiler.translator.tojava.GeneratedJavaFileType.DEFAULT_CLASS_MASK;
import static com.airlenet.yang.compiler.translator.tojava.GeneratedJavaFileType.GENERATE_ENUM_CLASS;
import static com.airlenet.yang.compiler.translator.tojava.GeneratedJavaFileType.GENERATE_EVENT_CLASS;
import static com.airlenet.yang.compiler.translator.tojava.GeneratedJavaFileType.GENERATE_EVENT_LISTENER_INTERFACE;
import static com.airlenet.yang.compiler.translator.tojava.GeneratedJavaFileType.GENERATE_EVENT_SUBJECT_CLASS;
import static com.airlenet.yang.compiler.translator.tojava.GeneratedJavaFileType.GENERATE_KEY_CLASS;
import static com.airlenet.yang.compiler.translator.tojava.GeneratedJavaFileType.GENERATE_RPC_COMMAND_CLASS;
import static com.airlenet.yang.compiler.translator.tojava.GeneratedJavaFileType.GENERATE_RPC_EXTENDED_COMMAND_CLASS;
import static com.airlenet.yang.compiler.translator.tojava.GeneratedJavaFileType.GENERATE_RPC_HANDLER_CLASS;
import static com.airlenet.yang.compiler.translator.tojava.GeneratedJavaFileType.GENERATE_RPC_REGISTER_CLASS;
...
import static com.airlenet.yang.compiler.translator.tojava.GeneratedTempFileType.ADD_TO_LIST_IMPL_MASK;
import static com.airlenet.yang.compiler.translator.tojava.GeneratedTempFileType.ADD_TO_LIST_INTERFACE_MASK;
import static com.airlenet.yang.compiler.translator.tojava.GeneratedTempFileType.ATTRIBUTES_MASK;
import static com.airlenet.yang.compiler.translator.tojava.GeneratedTempFileType.CONSTRUCTOR_FOR_TYPE_MASK;
import static com.airlenet.yang.compiler.translator.tojava.GeneratedTempFileType.ENUM_IMPL_MASK;
import static com.airlenet.yang.compiler.translator.tojava.GeneratedTempFileType.EQUALS_IMPL_MASK;
import static com.airlenet.yang.compiler.translator.tojava.GeneratedTempFileType.EVENT_ENUM_MASK;
import static com.airlenet.yang.compiler.translator.tojava.GeneratedTempFileType.EVENT_METHOD_MASK;
import static com.airlenet.yang.compiler.translator.tojava.GeneratedTempFileType.EVENT_SUBJECT_ATTRIBUTE_MASK;
import static com.airlenet.yang.compiler.translator.tojava.GeneratedTempFileType.EVENT_SUBJECT_GETTER_MASK;
import static com.airlenet.yang.compiler.translator.tojava.GeneratedTempFileType.EVENT_SUBJECT_SETTER_MASK;
import static com.airlenet.yang.compiler.translator.tojava.GeneratedTempFileType.FROM_STRING_IMPL_MASK;
import static com.airlenet.yang.compiler.translator.tojava.GeneratedTempFileType.GETTER_FOR_CLASS_MASK;
import static com.airlenet.yang.compiler.translator.tojava.GeneratedTempFileType.GETTER_FOR_INTERFACE_MASK;
import static com.airlenet.yang.compiler.translator.tojava.GeneratedTempFileType.HASH_CODE_IMPL_MASK;
import static com.airlenet.yang.compiler.translator.tojava.GeneratedTempFileType.LEAF_IDENTIFIER_ENUM_ATTRIBUTES_MASK;
import static com.airlenet.yang.compiler.translator.tojava.GeneratedTempFileType.OF_STRING_IMPL_MASK;
import static com.airlenet.yang.compiler.translator.tojava.GeneratedTempFileType.RPC_INTERFACE_MASK;
import static com.airlenet.yang.compiler.translator.tojava.GeneratedTempFileType.SETTER_FOR_CLASS_MASK;
import static com.airlenet.yang.compiler.translator.tojava.GeneratedTempFileType.SETTER_FOR_INTERFACE_MASK;
import static com.airlenet.yang.compiler.translator.tojava.GeneratedTempFileType.TO_STRING_IMPL_MASK;
import static com.airlenet.yang.compiler.translator.tojava.TempJavaFragmentFiles.getListOfAttributesForKey;
import static com.airlenet.yang.compiler.translator.tojava.TempJavaRpcCommandFragmentFiles.getRpcCommandContents;
import static com.airlenet.yang.compiler.translator.tojava.TempJavaRpcFragmentFiles.getRegisterRpcContents;
import static com.airlenet.yang.compiler.translator.tojava.TempJavaRpcFragmentFiles.getRpcExtendedCommandContents;
import static com.airlenet.yang.compiler.translator.tojava.TempJavaRpcFragmentFiles.getRpcHandlerContents;
import static com.airlenet.yang.compiler.translator.tojava.utils.IndentationType.FOUR_SPACE;
import static com.airlenet.yang.compiler.translator.tojava.utils.JavaCodeSnippetGen.addStaticAttributeIntRange;
import static com.airlenet.yang.compiler.translator.tojava.utils.JavaCodeSnippetGen.addStaticAttributeLongRange;
import static com.airlenet.yang.compiler.translator.tojava.utils.JavaCodeSnippetGen.addStaticAttributeShortRange;
import static com.airlenet.yang.compiler.translator.tojava.utils.JavaCodeSnippetGen.getEnumsValueAttribute;
import static com.airlenet.yang.compiler.translator.tojava.utils.JavaCodeSnippetGen.getEventEnumTypeStart;
import static com.airlenet.yang.compiler.translator.tojava.utils.JavaCodeSnippetGen.getJavaAttributeDefinition;
import static com.airlenet.yang.compiler.translator.tojava.utils.JavaCodeSnippetGen.getSetValueParaForUnionClass;
import static com.airlenet.yang.compiler.translator.tojava.utils.JavaFileGeneratorUtils.getDataFromTempFileHandle;
import static com.airlenet.yang.compiler.translator.tojava.utils.JavaFileGeneratorUtils.initiateJavaFileGeneration;
import static com.airlenet.yang.compiler.translator.tojava.utils.MethodBodyTypes.ENUM_METHOD_INT_VALUE;
import static com.airlenet.yang.compiler.translator.tojava.utils.MethodBodyTypes.ENUM_METHOD_STRING_VALUE;
import static com.airlenet.yang.compiler.translator.tojava.utils.MethodsGenerator.getAddAugmentationString;
import static com.airlenet.yang.compiler.translator.tojava.utils.MethodsGenerator.getAugmentationString;
import static com.airlenet.yang.compiler.translator.tojava.utils.MethodsGenerator.getAugmentationsString;
import static com.airlenet.yang.compiler.translator.tojava.utils.MethodsGenerator.getBitSetEnumClassFromString;
import static com.airlenet.yang.compiler.translator.tojava.utils.MethodsGenerator.getBitSetEnumClassToString;
import static com.airlenet.yang.compiler.translator.tojava.utils.MethodsGenerator.getEnumsConstructor;
import static com.airlenet.yang.compiler.translator.tojava.utils.MethodsGenerator.getEnumsOfValueMethod;
import static com.airlenet.yang.compiler.translator.tojava.utils.MethodsGenerator.getEqualsMethod;
import static com.airlenet.yang.compiler.translator.tojava.utils.MethodsGenerator.getEqualsMethodClose;
import static com.airlenet.yang.compiler.translator.tojava.utils.MethodsGenerator.getEqualsMethodOpen;
import static com.airlenet.yang.compiler.translator.tojava.utils.MethodsGenerator.getFromStringMethodClose;
import static com.airlenet.yang.compiler.translator.tojava.utils.MethodsGenerator.getFromStringMethodSignature;
import static com.airlenet.yang.compiler.translator.tojava.utils.MethodsGenerator.getGetter;
import static com.airlenet.yang.compiler.translator.tojava.utils.MethodsGenerator.getGetterForClass;
import static com.airlenet.yang.compiler.translator.tojava.utils.MethodsGenerator.getHashCodeMethod;
import static com.airlenet.yang.compiler.translator.tojava.utils.MethodsGenerator.getHashCodeMethodClose;
import static com.airlenet.yang.compiler.translator.tojava.utils.MethodsGenerator.getHashCodeMethodOpen;
import static com.airlenet.yang.compiler.translator.tojava.utils.MethodsGenerator.getInterfaceLeafIdEnumSignature;
import static com.airlenet.yang.compiler.translator.tojava.utils.MethodsGenerator.getRangeValidatorMethodForUnion;
import static com.airlenet.yang.compiler.translator.tojava.utils.MethodsGenerator.getRemoveAugmentationString;
import static com.airlenet.yang.compiler.translator.tojava.utils.MethodsGenerator.getSetterForClass;
import static com.airlenet.yang.compiler.translator.tojava.utils.MethodsGenerator.getToStringForEnumClass;
import static com.airlenet.yang.compiler.translator.tojava.utils.MethodsGenerator.getToStringForType;
import static com.airlenet.yang.compiler.translator.tojava.utils.MethodsGenerator.getToStringMethodClose;
import static com.airlenet.yang.compiler.translator.tojava.utils.MethodsGenerator.getToStringMethodOpen;
import static com.airlenet.yang.compiler.translator.tojava.utils.MethodsGenerator.getUnionToStringMethod;
import static com.airlenet.yang.compiler.translator.tojava.utils.JavaFileGeneratorUtils.getYangDataStructure;
import static com.airlenet.yang.compiler.translator.tojava.utils.MethodsGenerator.isLeafValueSetInterface;
import static com.airlenet.yang.compiler.translator.tojava.utils.StringGenerator.getImportString;
import static com.airlenet.yang.compiler.translator.tojava.utils.StringGenerator.getInterfaceLeafIdEnumMethods;
import static com.airlenet.yang.compiler.translator.tojava.utils.StringGenerator.getIsValueLeafSet;
...
import static com.airlenet.yang.compiler.translator.tojava.utils.TranslatorUtils.addDefaultConstructor;
import static com.airlenet.yang.compiler.translator.tojava.utils.TranslatorUtils.getBeanFiles;
import static com.airlenet.yang.compiler.translator.tojava.utils.TranslatorUtils.getTypeFiles;
...
import static com.airlenet.yang.compiler.utils.UtilConstants.COMMAND;
import static com.airlenet.yang.compiler.utils.UtilConstants.DEFAULT_CAPS;
import static com.airlenet.yang.compiler.utils.UtilConstants.DEFAULT_RPC_HANDLER;
import static com.airlenet.yang.compiler.utils.UtilConstants.DIAMOND_CLOSE_BRACKET;
import static com.airlenet.yang.compiler.utils.UtilConstants.DIAMOND_OPEN_BRACKET;
import static com.airlenet.yang.compiler.utils.UtilConstants.EMPTY_STRING;
import static com.airlenet.yang.compiler.utils.UtilConstants.ENUM_CLASS;
import static com.airlenet.yang.compiler.utils.UtilConstants.EVENT_CLASS;
...
import static com.airlenet.yang.compiler.utils.UtilConstants.EVENT_SUBJECT_NAME_SUFFIX;
import static com.airlenet.yang.compiler.utils.UtilConstants.EXTEND;
import static com.airlenet.yang.compiler.utils.UtilConstants.IMPL_CLASS;
import static com.airlenet.yang.compiler.utils.UtilConstants.INT;
import static com.airlenet.yang.compiler.utils.UtilConstants.INTERFACE;
import static com.airlenet.yang.compiler.utils.UtilConstants.JAVA_UTIL_OBJECTS_IMPORT_CLASS;
import static com.airlenet.yang.compiler.utils.UtilConstants.JAVA_UTIL_PKG;
import static com.airlenet.yang.compiler.utils.UtilConstants.KEYS;
import static com.airlenet.yang.compiler.utils.UtilConstants.KEY_INFO;
import static com.airlenet.yang.compiler.utils.UtilConstants.MODEL_PKG;
...
import static com.airlenet.yang.compiler.utils.UtilConstants.PROTECTED;
...
import static com.airlenet.yang.compiler.utils.UtilConstants.REGISTER_RPC;
import static com.airlenet.yang.compiler.utils.UtilConstants.RPC_CLASS;
import static com.airlenet.yang.compiler.utils.UtilConstants.RPC_EXTENDED_COMMAND;
import static com.airlenet.yang.compiler.utils.UtilConstants.SEMI_COLON;
import static com.airlenet.yang.compiler.utils.UtilConstants.SERVICE_METHOD_STRING;
import static com.airlenet.yang.compiler.utils.UtilConstants.SPACE;
import static com.airlenet.yang.compiler.utils.UtilConstants.TYPEDEF_CLASS;
import static com.airlenet.yang.compiler.utils.UtilConstants.UNION_CLASS;
...
import static com.airlenet.yang.compiler.utils.io.impl.YangIoUtils.formatFile;
...
import static com.airlenet.yang.compiler.utils.io.impl.YangIoUtils.insertDataIntoJavaFile;
import static com.airlenet.yang.compiler.utils.io.impl.YangIoUtils.replaceLast;
...
public final class JavaFileGenerator {
    ...
    public static File generateTypeDefClassFile(File file, YangNode curNode,
        ...
        initiateJavaFileGeneration(file, className, GENERATE_TYPEDEF_CLASS,
                                   imports, path,fileInfo.getYangFileName(),fileInfo.getLineNumber());
    ...
    public static File generateEnumClassFile(File file, YangNode curNode, List<String> imports)
        ...
        initiateJavaFileGeneration(file, getCapitalCase(className),
                                   GENERATE_ENUM_CLASS, imports, path,fileInfo.getYangFileName(),fileInfo.getLineNumber());
