...
import com.airlenet.yang.compiler.datamodel.YangTranslatorOperatorNode;
...
import static com.airlenet.yang.compiler.translator.tojava.TempJavaFragmentFiles.addCurNodeInfoInParentTempFile;
...
import static com.airlenet.yang.compiler.translator.tojava.utils.TranslatorErrorType.INVALID_TRANSLATION_NODE;
...
import static com.airlenet.yang.compiler.translator.tojava.utils.TranslatorUtils.getErrorMsgForCodeGenerator;
...
import static com.airlenet.yang.compiler.utils.UtilConstants.INPUT_KEYWORD;
import static com.airlenet.yang.compiler.utils.UtilConstants.OUTPUT_KEYWORD;
...
public final class YangJavaModelUtils {
    ...
    public static void generateInterfaceFileForNonDataNodes(YangNode rootNode) throws
        ...
        addPackageInfo(filePath, name, fileInfo.getPackage(), false,fileInfo.getYangFileName(),fileInfo.getLineNumber());
