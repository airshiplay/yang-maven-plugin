...
import com.airlenet.yang.compiler.translator.tojava.utils.StringGenerator;
...
import static com.airlenet.yang.compiler.utils.UtilConstants.ARRAY_LIST_IMPORT;
...
import static com.airlenet.yang.compiler.utils.UtilConstants.DATA_NODE;
import static com.airlenet.yang.compiler.utils.UtilConstants.EMPTY_STRING;
import static com.airlenet.yang.compiler.utils.UtilConstants.EVENT_LISTENER;
...
import static com.airlenet.yang.compiler.utils.UtilConstants.JAVA_UTIL_CONCURRENT_PKG;
...
import static com.airlenet.yang.compiler.utils.UtilConstants.JAVA_UTIL_REGEX_PKG;
import static com.airlenet.yang.compiler.utils.UtilConstants.LINKED_LIST;
...
import static com.airlenet.yang.compiler.utils.UtilConstants.ONOS_EVENT_PKG;
...
import static com.airlenet.yang.compiler.utils.UtilConstants.RPC_OUTPUT_STATUS_PKG;
...
public class JavaImportData {
    ...
    public List<String> getImports(boolean isForInterface) {
        ...
        for (JavaQualifiedTypeInfoTranslator importInfo : getImportSet()) {
            ...
            if (!importInfo.getPkgInfo().equals(EMPTY_STRING) &&
                    ...
                    check) {
                importString = StringGenerator.getImportString(importInfo.getPkgInfo(), importInfo
                        .getClassInfo());
    ...
    String getImportForHashAndEquals() {
        return StringGenerator.getImportString(JAVA_UTIL_PKG,
    ...
    public String getImportForToBitSet() {
        return StringGenerator.getImportString(JAVA_UTIL_PKG, BITSET);
    }
    ...
    public String getImportForPattern() {
        return StringGenerator.getImportString(JAVA_UTIL_REGEX_PKG, PATTERN);
    }
    ...
    public String getImportForList() {
        return StringGenerator.getImportString(COLLECTION_IMPORTS, LIST);
    }
    ...
    private String getImportForMap() {
        return StringGenerator.getImportString(COLLECTION_IMPORTS, MAP);
    }
    ...
    private String getImportForQueue() {
        return StringGenerator.getImportString(COLLECTION_IMPORTS, QUEUE);
    }
    ...
    private String getImportForSet() {
        return StringGenerator.getImportString(COLLECTION_IMPORTS, SET);
    }
    ...
    public String getListenerServiceImport() {
        return StringGenerator.getImportString(ONOS_EVENT_PKG, LISTENER_SERVICE);
    }
    ...
    String getAbstractEventsImport() {
        return StringGenerator.getImportString(ONOS_EVENT_PKG, ABSTRACT_EVENT);
    }
    ...
    String getEventListenerImport() {
        return StringGenerator.getImportString(ONOS_EVENT_PKG, EVENT_LISTENER);
    }
    ...
    public String getBigIntegerImport() {
        return StringGenerator.getImportString(JAVA_MATH, BIG_INTEGER);
    }
    ...
    public String getExecutorServiceImport() {
        return StringGenerator.getImportString(JAVA_UTIL_CONCURRENT_PKG, EXECUTOR_SERVICE);
    }
    ...
    public String getExecutorsImport() {
        return StringGenerator.getImportString(JAVA_UTIL_CONCURRENT_PKG, EXECUTORS);
    }
    ...
    public String getImportForRpcCommand() {
        return StringGenerator.getImportString(MODEL_PKG, RPC_COMMAND);
    }
    ...
    public String getImportForRpcHandler() {
        return StringGenerator.getImportString(MODEL_PKG, RPC_HANDLER);
    }
    ...
    public String getImportForDynamicStoreService() {
        return StringGenerator.getImportString(MODEL_PKG, YANG_RPC_SERVICE);
    }
    ...
    public String getImportForDataNode() {
        return StringGenerator.getImportString(MODEL_PKG, DATA_NODE);
    }
    ...
    public String getImportForRpcSuccess() {
        return StringGenerator.getStaticImportString(RPC_OUTPUT_STATUS_PKG, RPC_SUCCESS);
    }
    ...
    public String getImportForRpcInput() {
        return StringGenerator.getImportString(MODEL_PKG, RPC_INPUT);
    }
    ...
    public String getImportForRpcOutput() {
        return StringGenerator.getImportString(MODEL_PKG, RPC_OUTPUT);
    }
    ...
    public String getImportForModelConverter() {
        return StringGenerator.getImportString(MODEL_PKG, MODEL_CONVERTER);
    }
    ...
    public String getImportForResourceId() {
        return StringGenerator.getImportString(MODEL_PKG, RESOURCE_ID);
    }
    ...
    public String getImportForLinkedList() {
        return StringGenerator.getImportString(COLLECTION_IMPORTS, LINKED_LIST);
    }
