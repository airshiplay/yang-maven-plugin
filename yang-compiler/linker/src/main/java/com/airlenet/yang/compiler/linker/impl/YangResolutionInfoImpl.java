...
import com.airlenet.yang.compiler.datamodel.DefaultLocationInfo;
import com.airlenet.yang.compiler.datamodel.Resolvable;
...
import com.airlenet.yang.compiler.datamodel.YangEntityToResolveInfoImpl;
...
import com.airlenet.yang.compiler.datamodel.YangXPathResolver;
...
import static com.airlenet.yang.compiler.datamodel.YangNode.cloneGroupingTree;
import static com.airlenet.yang.compiler.datamodel.YangPathArgType.ABSOLUTE_PATH;
import static com.airlenet.yang.compiler.datamodel.YangPathArgType.RELATIVE_PATH;
...
import static com.airlenet.yang.compiler.datamodel.utils.DataModelUtils.deleteUnsupportedLeafOrLeafList;
import static com.airlenet.yang.compiler.datamodel.utils.DataModelUtils.deleteUnsupportedNodeFromTree;
import static com.airlenet.yang.compiler.datamodel.utils.DataModelUtils.findLeafNode;
import static com.airlenet.yang.compiler.datamodel.utils.DataModelUtils.updateDeviateAddToTargetNode;
import static com.airlenet.yang.compiler.datamodel.utils.DataModelUtils.updateDeviateDeleteToTargetNode;
import static com.airlenet.yang.compiler.datamodel.utils.DataModelUtils.updateDeviateReplaceToTargetNode;
import static com.airlenet.yang.compiler.datamodel.utils.ResolvableStatus.INTER_FILE_LINKED;
import static com.airlenet.yang.compiler.datamodel.utils.ResolvableStatus.INTRA_FILE_RESOLVED;
import static com.airlenet.yang.compiler.datamodel.utils.ResolvableStatus.LINKED;
import static com.airlenet.yang.compiler.datamodel.utils.ResolvableStatus.RESOLVED;
import static com.airlenet.yang.compiler.datamodel.utils.ResolvableStatus.UNDEFINED;
...
import static com.airlenet.yang.compiler.datamodel.utils.YangConstructType.LEAF_LIST_DATA;
import static com.airlenet.yang.compiler.datamodel.utils.YangConstructType.PATH_DATA;
import static com.airlenet.yang.compiler.linker.impl.XpathLinkingTypes.AUGMENT_LINKING;
import static com.airlenet.yang.compiler.linker.impl.XpathLinkingTypes.DEVIATION_LINKING;
import static com.airlenet.yang.compiler.linker.impl.XpathLinkingTypes.LEAF_REF_LINKING;
import static com.airlenet.yang.compiler.utils.UtilConstants.EMPTY_STRING;
import static com.airlenet.yang.compiler.utils.UtilConstants.FAILED_TO_FIND_ANNOTATION;
import static com.airlenet.yang.compiler.utils.UtilConstants.FAILED_TO_FIND_DEVIATION;
import static com.airlenet.yang.compiler.utils.UtilConstants.FAILED_TO_FIND_LEAD_INFO_HOLDER;
import static com.airlenet.yang.compiler.utils.UtilConstants.FAILED_TO_LINK;
import static com.airlenet.yang.compiler.utils.UtilConstants.INVALID_ENTITY;
import static com.airlenet.yang.compiler.utils.UtilConstants.INVALID_LINKER_STATE;
import static com.airlenet.yang.compiler.utils.UtilConstants.INVALID_RESOLVED_ENTITY;
import static com.airlenet.yang.compiler.utils.UtilConstants.INVALID_TARGET;
...
import static com.airlenet.yang.compiler.utils.UtilConstants.LINKER_ERROR;
import static com.airlenet.yang.compiler.utils.UtilConstants.SLASH_FOR_STRING;
import static com.airlenet.yang.compiler.utils.UtilConstants.UNRESOLVABLE;
...
public class YangResolutionInfoImpl<T> extends DefaultLocationInfo
                ...
                case UNRESOLVED:
                    ...
                    if (resolvable.getResolvableStatus() == UNRESOLVED) {
                        ...
                        DataModelException ex = new DataModelException(
                                YangLinkerUtils.getErrorInfoForLinker(resolvable));
        ...
        if (entityToResolve instanceof YangAugment &&
            ...
            if (targetNode != null) {
                if (targetNode instanceof YangAugmentableNode) {
                    YangLinkerUtils.detectCollisionForAugment(targetNode, augment,
                                              (YangNode) root);
    ...
    private void linkInterFileTopOfStackRefUpdateStack()
        ...
        if (refNode == null) {
            ...
            DataModelException ex = new DataModelException(
                    YangLinkerUtils.getErrorInfoForLinker(entity));
            ex.setLine(getLineNumber());
            ex.setCharPosition(getCharPosition());
            throw ex;
        } else {
    ...
    private void fillAbsolutePathValuesInLeafref(YangLeafRef leafref, String path,
        ...
        for (String value : pathName) {
            if (value != null && !value.isEmpty() && !value.equals(EMPTY_STRING)) {
                YangNodeIdentifier nodeId = YangLinkerUtils.getValidNodeIdentifier(value, PATH_DATA);
    ...
    private T getRootNodeWithAncestorCountForLeafref(
        ...
        curParent = YangLinkerUtils.skipInvalidDataNodes(curParent, leafref);
        if (curParent instanceof YangAugment) {
            YangAugment augment = (YangAugment) curParent;
            Object valueInAugment = YangLinkerUtils.getPathWithAugment(augment,
            ...
            while (curParentCount < ancestorCount) {
                ...
                if (curParent instanceof YangAugment) {
                    YangAugment augment = (YangAugment) curParent;
                    Object valueInAugment = YangLinkerUtils.getPathWithAugment(
