...
public abstract class YangChoice
    ...
    public YangChoice() {
        ...
        yangAppErrorInfo.setErrorAppTag(YangErrMsgConstants.MISSING_CHOICE_ERROR_APP_TAG);
        yangAppErrorInfo.setErrorAppPath(YangErrMsgConstants.ERROR_PATH_MISSING_CHOICE);
    }
    ...
    public void detectCollidingChild(String idName, YangConstructType type)
        ...
        if (getParent() instanceof YangCase && type != YangConstructType.CASE_DATA) {
            ...
            if (getName().equals(identifierName)) {
                throw new DataModelException(
                        ErrorMessages.getErrorMsgCollision(ErrorMessages.COLLISION_DETECTION, getName(),
                                             ...
                                             ErrorMessages.CHOICE, getFileName()));
            }
            return;
        }
