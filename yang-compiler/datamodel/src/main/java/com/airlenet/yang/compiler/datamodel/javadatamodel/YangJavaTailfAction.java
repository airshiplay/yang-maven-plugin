...
import com.airlenet.yang.compiler.datamodel.YangAction;
import com.airlenet.yang.compiler.datamodel.YangTailfAction;

/**
 * Represents YANG java rpc.
 */
public class YangJavaTailfAction
        extends YangTailfAction {
