...
import com.airlenet.yang.compiler.datamodel.YangMinElement;
...
public final class MinElementsListener {
    ...
    public static void processMinElementsEntry(TreeWalkListener listener,
        ...
        ListenerValidation.checkStackIsNotEmpty(listener, ListenerErrorType.MISSING_HOLDER, MIN_ELEMENT_DATA,
                             ctx.minValue().getText(), ListenerErrorLocation.ENTRY);

        int minElementValue = ListenerUtil.getValidNonNegativeIntegerValue(
        ...
        if (tmpData instanceof YangMinElementHolder) {
            ...
            throw new ParserException(ListenerErrorMessageConstruction.constructListenerErrorMessage(
                    ListenerErrorType.INVALID_HOLDER, MIN_ELEMENT_DATA, ctx.minValue().getText(),
