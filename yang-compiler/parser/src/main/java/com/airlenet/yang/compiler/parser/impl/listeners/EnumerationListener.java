...
import com.airlenet.yang.compiler.parser.antlrgencode.GeneratedYangParser.EnumSpecificationContext;

import static com.airlenet.yang.compiler.datamodel.utils.GeneratedLanguage.JAVA_GENERATION;
import static com.airlenet.yang.compiler.datamodel.utils.YangConstructType.ENUMERATION_DATA;
import static com.airlenet.yang.compiler.datamodel.utils.YangConstructType.TYPE_DATA;
import static com.airlenet.yang.compiler.translator.tojava.YangDataModelFactory.getYangEnumerationNode;
...
public final class EnumerationListener {
    ...
    public static void processEnumerationEntry(TreeWalkListener listener,
        ...
        ListenerValidation.checkStackIsNotEmpty(listener, ListenerErrorType.MISSING_HOLDER, ENUMERATION_DATA, "", ListenerErrorLocation.ENTRY);
        ...
        if (listener.getParsedDataStack().peek() instanceof YangType) {
            ...
            throw new ParserException(ListenerErrorMessageConstruction.constructListenerErrorMessage(ListenerErrorType.INVALID_HOLDER, ENUMERATION_DATA, "", ListenerErrorLocation.ENTRY));
        }
    }
    ...
    public static void processEnumerationExit(TreeWalkListener listener,
        ...
        // Check for stack to be non empty.
        ListenerValidation.checkStackIsNotEmpty(listener, ListenerErrorType.MISSING_HOLDER, ENUMERATION_DATA, "", ListenerErrorLocation.EXIT);
            ...
            switch (tmpNode.getYangConstructType()) {
                ...
                default:
                    throw new ParserException(
                            ListenerErrorMessageConstruction.constructListenerErrorMessage(ListenerErrorType.INVALID_HOLDER, ENUMERATION_DATA, "", ListenerErrorLocation.EXIT));
            }
        } else {
            throw new ParserException(
                    ListenerErrorMessageConstruction.constructListenerErrorMessage(ListenerErrorType.MISSING_CURRENT_HOLDER, ENUMERATION_DATA, "", ListenerErrorLocation.EXIT));
        }
    }
    ...
    private static void addChildToParentNode(TreeWalkListener listener, YangEnumeration enumerationNode) {
        if (!(listener.getParsedDataStack().peek() instanceof YangNode)) {
            throw new ParserException(ListenerErrorMessageConstruction.constructListenerErrorMessage(ListenerErrorType.INVALID_HOLDER, ENUMERATION_DATA,
                                                                    "", ListenerErrorLocation.ENTRY));
        } else {
            ...
            try {
                ...
                throw new ParserException(ListenerErrorMessageConstruction.constructExtendedListenerErrorMessage(
                        ListenerErrorType.UNHANDLED_PARSED_DATA, ENUMERATION_DATA, "", ListenerErrorLocation.ENTRY, e.getMessage()));
            }
        }
    }
}
