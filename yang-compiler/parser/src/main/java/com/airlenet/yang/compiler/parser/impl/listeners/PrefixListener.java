...
import static com.airlenet.yang.compiler.datamodel.utils.YangConstructType.PREFIX_DATA;
...
public final class PrefixListener {
    ...
    public static void processPrefixEntry(TreeWalkListener listener, PrefixStatementContext ctx) {
        ...
        ListenerValidation.checkStackIsNotEmpty(listener, ListenerErrorType.MISSING_HOLDER, PREFIX_DATA, ctx.identifier().getText(), ListenerErrorLocation.ENTRY);

        String identifier = ListenerUtil.getValidIdentifier(ctx.identifier().getText(), PREFIX_DATA, ctx);
        ...
        switch (tmpNode.getYangConstructType()) {
            ...
            default:
                throw new ParserException(ListenerErrorMessageConstruction.constructListenerErrorMessage(ListenerErrorType.INVALID_HOLDER, PREFIX_DATA,
