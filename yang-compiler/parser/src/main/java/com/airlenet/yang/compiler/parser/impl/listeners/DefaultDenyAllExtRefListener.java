...
import com.airlenet.yang.compiler.datamodel.DefaultDenyAllExtension;
...
import static com.airlenet.yang.compiler.datamodel.utils.YangConstructType.DEFAULT_DENY_ALL_DATA;
...
public final class DefaultDenyAllExtRefListener {
    ...
    public static void processDefaultDenyAllStructureEntry(
        ...
        ListenerValidation.checkStackIsNotEmpty(listener, ListenerErrorType.MISSING_HOLDER, DEFAULT_DENY_ALL_DATA,
        ...
        if (tmpData instanceof DefaultDenyAllExtension) {
            ...
            throw new ParserException(ListenerErrorMessageConstruction.constructListenerErrorMessage(
                    ListenerErrorType.INVALID_HOLDER, DEFAULT_DENY_ALL_DATA, "", ListenerErrorLocation.ENTRY));
        }
    }
}
