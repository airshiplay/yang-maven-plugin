...
import static com.airlenet.yang.compiler.datamodel.utils.YangConstructType.ENUM_DATA;
...
public final class EnumListener {
    ...
    public static void processEnumEntry(TreeWalkListener listener, EnumStatementContext ctx) {
        ...
        ListenerValidation.checkStackIsNotEmpty(listener, ListenerErrorType.MISSING_HOLDER, ENUM_DATA, ctx.string().getText(), ListenerErrorLocation.ENTRY);
    ...
    public static void processEnumExit(TreeWalkListener listener, EnumStatementContext ctx) {
        ...
        // Check for stack to be non empty.
        ListenerValidation.checkStackIsNotEmpty(listener, ListenerErrorType.MISSING_HOLDER, ENUM_DATA, ctx.string().getText(), ListenerErrorLocation.EXIT);
            ...
            switch (tmpNode.getYangConstructType()) {
                case ENUMERATION_DATA: {
                    ...
                    try {
                        ...
                        ParserException parserException =
                                new ParserException(ListenerErrorMessageConstruction.constructExtendedListenerErrorMessage(ListenerErrorType.DUPLICATE_ENTRY, ENUM_DATA,
                ...
                default:
                    throw new ParserException(
                            ListenerErrorMessageConstruction.constructListenerErrorMessage(ListenerErrorType.INVALID_HOLDER, ENUM_DATA, ctx.string().getText(), ListenerErrorLocation.EXIT));
            }
        } else {
            throw new ParserException(
                    ListenerErrorMessageConstruction.constructListenerErrorMessage(ListenerErrorType.MISSING_CURRENT_HOLDER, ENUM_DATA, ctx.string().getText(), ListenerErrorLocation.EXIT));
        }
    }
}
