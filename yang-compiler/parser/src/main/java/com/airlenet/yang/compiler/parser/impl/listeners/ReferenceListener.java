...
import com.airlenet.yang.compiler.datamodel.YangReference;
...
public final class ReferenceListener {
    ...
    public static void processReferenceEntry(TreeWalkListener listener,
        ...
        ListenerValidation.checkStackIsNotEmpty(listener, ListenerErrorType.MISSING_HOLDER, REFERENCE_DATA, ctx.string().getText(), ListenerErrorLocation.ENTRY);
        ...
        if (tmpData instanceof YangReference) {
            ...
            throw new ParserException(ListenerErrorMessageConstruction.constructListenerErrorMessage(ListenerErrorType.INVALID_HOLDER, REFERENCE_DATA,
