...
import static com.airlenet.yang.compiler.translator.tojava.YangDataModelFactory.getYangTailfActionNode;
 ...
 */
public final class TailfActionListener {

    /**
     * Creates a new rpc listener.
     */
    private TailfActionListener() {
    }
    ...
    public static void processActionEntry(TreeWalkListener listener,
                                          GeneratedYangParser.TailfActionStatementContext ctx) {
...
//        validateSubStatementsCardinality(ctx);
        ...
        if (curData instanceof YangModule || curData instanceof YangSubModule
                || curData instanceof YangContainer || curData instanceof YangList || curData instanceof YangAugment|| curData instanceof YangGrouping) {

            YangNode curNode = (YangNode) curData;
            YangTailfAction yangAction = getYangTailfActionNode(JAVA_GENERATION);
...
//            ((RpcNotificationContainer) curData).setRpcPresent(true);
    ...
    public static void processActionExit(TreeWalkListener listener,
        ...
        if (!(listener.getParsedDataStack().peek() instanceof YangTailfAction)) {
     ...
     * @param ctx context object of the grammar rule
     */
    private static void validateSubStatementsCardinality(GeneratedYangParser.UnknownStatementContext ctx) {
