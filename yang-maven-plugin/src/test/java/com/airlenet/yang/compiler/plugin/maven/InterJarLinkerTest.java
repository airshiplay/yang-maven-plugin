...
import com.airlenet.yang.compiler.tool.YangFileInfo;
...
public class InterJarLinkerTest {
    ...
    private static final String FLOW_CLASSIFIER_FOLDER = "target/interJarFileLinking/com/airlenet"
            + "/yang/gen/v1/flowclassifier/rev20160524";
    private static final String PORT_PAIR_FOLDER = "target/interJarFileLinking/com/airlenet"
